...
class Grid():
    ...
    def counter_4(self):
        """
        Compte le nombre de cellules interdites (noires).
        """
        c = 0
        for i in range(self.n):
    ...
    def test_color(self,c1,c2):
        """
        Vérifie si deux cellules peuvent être appariées.
        """
        if (self.color[c1[0]][c1[1]],self.color[c2[0]][c2[1]]) in [(0,1),(0,2),(0,3),(0,0),(1,0),(2,0),(3,0),(1,2),(2,1),(1,1),(2,2),(3,3)]:
            return True
        return False
